$(document).ready(function () {
    ...
    function music_player() {
        ...
        //添加歌词
        var lyric={"lyrics":"https://api.bzqll.com/music/netease/lrc?id="+id+"&key=579621905"}
        var lyrics="<iframe src='"+lyric.lyrics+"'width='400px'height='700px'></iframe>";
        $("#music_lyrics").append(lyrics);
        //添加H5播放器
        var player="<audio class='player' id='player' src='http://api.bzqll.com/music/netease/url?id="+id+"&key=579621905&br=999000'controls='controls' loop='loop' autoplay='autoplay'> 兄弟浏览器该更新了</audio>"
